                    ...
                    <div class="col-md-7 col-sm-7 col-xs-7">
                        <div class="wrapper-menu">
                            <ul>
                                ...
                                <li><a href="<?php $category_id = get_cat_ID( 'Новости' ); echo get_category_link( $category_id ); ?>">Новости</a></li>
                                <li><a href="#" class="services-link">Услуги</a></li>
                                <li><a href="#" class="connection-link">Связь</a></li>
                            </ul>
                        </div>
                    </div>
